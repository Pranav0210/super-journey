...
function Calendar({
  ...
  const now = new Date();
  const minSelectableDate = new Date(now.getTime() + 48 * 60 * 60 * 1000);
  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        selected:
          "bg-black text-primary hover:bg-primary hover:text-primary-foreground focus:bg-primary focus:text-primary-foreground rounded-l-md rounded-r-md",
        today: "bg-white text-accent-foreground",
        outside:
        ...
        MonthCaption: ({ calendarMonth }) => {
          return (
            <div className="inline-flex gap-2">
              ...
              >
                <SelectTrigger className="w-fit gap-1 border-none p-0 shadow-none focus:bg-accent focus:text-accent-foreground">
                  <SelectValue />
                </SelectTrigger>
                <SelectContent>
                  {MONTHS.map((month) => (
              ...
              >
                <SelectTrigger className="w-fit gap-1 border-none p-0 shadow-none focus:!border-none focus:bg-accent focus:text-accent-foreground">
                  <SelectValue />
                </SelectTrigger>
                <SelectContent>
                  {YEARS.map((year) => (
